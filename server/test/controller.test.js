...
describe('Test POST /api/v2/messages Endpoint', () => {
  it('Should send a message to user', (done) => {
    chai.request(app)
...
describe('Test GET /api/v2/messages/unread Endpoint', () => {
  it('Should get all user unread mails', (done) => {
    chai.request(app)
...
describe('Test GET /api/v2/messages/sent Endpoint', () => {
  it('Should get all user sent mails', (done) => {
    chai.request(app)
...
describe('Test GET /api/v2/messages/:messageId Endpoint', () => {
  it('Should get a specific mail record', (done) => {
    chai.request(app)
...
describe('Test DELETE /api/v2/messages/:messageId Endpoint', () => {
  it('Should delete a specific mail record', (done) => {
    chai.request(app)
  ...
  it('Should create a group', (done) => {
    chai.request(app)
      ...
      .send({
        ...
        groupmail: faker.internet.email(),
      })
      .end((err, res) => {
        expect(res).to.have.status(201);
        expect(res.body).to.be.a('object');
...
describe('Test GET /api/v2/groups Endpoint', () => {
  it('Should all groups by user', (done) => {
    chai.request(app)
      .get('/api/v2/groups')
      .set('Content-Type', 'application/json')
      .set({ 'x-access-token': userToken, Accept: 'application/json' })
...
describe('Test POST /api/v2/groups/:groupId/users Endpoint', () => {
  it('Should add a user to group', (done) => {
    chai.request(app)
...
describe('Test DELETE /api/v2/groups/:groupId/users/:userId Endpoint', () => {
  it('Should delete a user from group', (done) => {
    chai.request(app)
...
describe('Test POST /api/v2/groups/:groupId/messages Endpoint', () => {
  it('Should send message a user from group', (done) => {
    chai.request(app)
