...
router.get('/api/v1/messages/unread/:id', _messages.default.getAllUnreadMailByUser);
router.get('/api/v1/messages/sent/:id', _messages.default.getAllMailsSentByUser);
router.get('/api/v1/messages/:id', _messages.default.getAMailRecord);
router.delete('/api/v1/messages/:id', _messages.default.deleteUserMail);
